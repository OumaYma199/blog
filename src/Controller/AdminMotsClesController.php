...
#[Route('/admin/motscles')]
class AdminMotsClesController extends AbstractController
{
    #[Route('/', name: 'app_admin_mots_cles_index', methods: ['GET'])]
    public function index(MotsClesRepository $motsClesRepository): Response
    {
        return $this->render('admin_mots_cles/index.html.twig', [
            'mots_cles' => $motsClesRepository->findAll(),
        ]);
    }

    #[Route('/new', name: 'app_admin_mots_cles_new', methods: ['GET', 'POST'])]
    public function new(Request $request, MotsClesRepository $motsClesRepository): Response
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            return $this->redirectToRoute('app_admin_mots_cles_index', [], Response::HTTP_SEE_OTHER);
        }

        return $this->renderForm('admin_mots_cles/new.html.twig', [
            'mots_cle' => $motsCle,
            'form' => $form,
        ]);
    }

    #[Route('/{id}', name: 'app_admin_mots_cles_show', methods: ['GET'])]
    public function show(MotsCles $motsCle): Response
    {
        return $this->render('admin_mots_cles/show.html.twig', [
            'mots_cle' => $motsCle,
        ]);
    }

    #[Route('/{id}/edit', name: 'app_admin_mots_cles_edit', methods: ['GET', 'POST'])]
    public function edit(Request $request, MotsCles $motsCle, MotsClesRepository $motsClesRepository): Response
    {
        ...
        return $this->renderForm('admin_mots_cles/edit.html.twig', [
            'mots_cle' => $motsCle,
            'form' => $form,
        ]);
    }

    #[Route('/{id}', name: 'app_admin_mots_cles_delete', methods: ['POST'])]
